...
hdl.mod <- function(traits,sample.prev=NA,population.prev=NA,trait.names=NULL,LD.path,Nref = 335265,method="piecewise"){
  ...
  #mod-jz modification - Produce a warning and continue rather than abort the whole computation of standardised results. 
  #Did this to continue running analyses when encountering these errors, which occur when low SNP overlap?
